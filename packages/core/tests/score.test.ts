...
import { computePostureScore } from "../src/score.js";
import type { Finding, Severity, FindingStatus } from "../src/types.js";

function f(severity: Severity, status: FindingStatus = "FAIL"): Finding {
  return {
